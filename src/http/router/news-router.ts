            ...
            schema: {
                ...
                querystring: {
                    ...
                    properties: {
                        ...
                        status: { type: 'string', enum: ['PUBLISHED', 'UNPUBLISHED'], description: 'Filtrar por status' },
                    },
                },
                response: {
                    200: {
                        ...
                        properties: {
                            data: {
                                type: 'array',
                                items: { type: 'object', properties: newsProperties },
                            },
                            total: { type: 'integer' },
                            page: { type: 'integer' },
                            limit: { type: 'integer' },
        ...
        '/news',
        {
            schema: {
                ...
                body: {
                    ...
                    properties: {
                        title: { type: 'string', example: 'Sindicato realiza assembleia geral em agosto' },
                        content: { type: 'string', example: '<p>A assembleia geral será realizada no dia 10 de agosto...</p>' },
                        summary: { type: 'string', example: 'Assembleia geral com pauta sobre renovação de diretoria.' },
                        status: { type: 'string', enum: ['PUBLISHED', 'UNPUBLISHED'], example: 'UNPUBLISHED' },
                        publishedAt: { type: 'string', format: 'date-time', example: '2026-08-10T08:00:00-03:00' },
                    },
                },
                response: {
        ...
        '/news/:newsId',
        {
            schema: {
                ...
                body: {
                    type: 'object',
                    properties: {
                        title: { type: 'string', example: 'Assembleia geral em agosto — novo título' },
                        content: { type: 'string', example: '<p>Conteúdo atualizado...</p>' },
                        summary: { type: 'string', nullable: true, example: 'Resumo atualizado da notícia.' },
                        status: { type: 'string', enum: ['PUBLISHED', 'UNPUBLISHED'], example: 'PUBLISHED' },
                        publishedAt: { type: 'string', format: 'date-time', nullable: true, example: '2026-08-10T08:00:00-03:00' },
                    },
                },
                response: {
