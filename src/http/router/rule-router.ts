        ...
        '/rules',
        {
            schema: {
                ...
                body: {
                    ...
                    properties: {
                        name: { type: 'string', example: 'Gestor de Cursos' },
                        description: { type: 'string', example: 'Pode criar, editar e excluir cursos e visualizar inscrições.' },
                        permissions: {
                            type: 'array',
                            minItems: 1,
                            items: { type: 'string', enum: PERMISSIONS_ENUM },
