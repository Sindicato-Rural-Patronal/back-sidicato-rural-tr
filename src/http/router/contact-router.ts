        ...
        '/contacts/message',
        {
            schema: {
                ...
                body: {
                    ...
                    properties: {
                        name: { type: 'string', maxLength: 100, example: 'Maria Oliveira' },
                        email: { type: 'string', format: 'email', maxLength: 150, example: 'maria@example.com' },
                        phone: { type: 'string', maxLength: 50, nullable: true, example: '44999990002' },
                        subject: { type: 'string', maxLength: 50, nullable: true, example: 'Dúvida sobre inscrição' },
                        message: { type: 'string', minLength: 1, maxLength: 2000, example: 'Gostaria de saber mais informações sobre o próximo curso de manejo.' },
                    },
                },
                response: {
                    201: {
            ...
            schema: {
                ...
                querystring: {
                    ...
                    properties: {
                        ...
                        read: { type: 'boolean', description: 'Filtrar por status de leitura' },
                        search: { type: 'string', description: 'Busca por nome, email ou assunto' },
                    },
                },
                response: {
                    200: {
